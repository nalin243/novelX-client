function Navbar(props){
  ...
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="https://flowbite.com/" class="flex items-center">
        <img src="https://mpng.subpng.com/20190617/csw/kisspng-computer-icons-book-clip-art-portable-network-grap-5d0765d3a53d54.3041003315607659076768.jpg" class="mr-4 h-6 sm:h-9 rounded-full" alt="Flowbite Logo" />
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{props.name}</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 bg-blue-700 rounded md:bg-transparent md:hover:text-orange-500 md:p-0 dark:text-white" aria-current="page">Home</a>
        </li>
        <li>
