...
function LeftCard(props){
	...
	childComponents.set("Search Area",(<SearchArea/>))

	return (
		<div class="flex flex-3 bg-black justify-center w-3/4 h-4/6 md:h-4/6 xl:h-4/6  mr-auto mr-1 ml-6 mt-12 overflow-hidden rounded-lg border-2 border-gray-300 shadow-slate-500 shadow-2xl drop-shadow-3xl">
			{
